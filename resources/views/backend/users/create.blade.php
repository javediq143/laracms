  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-default">     
        <div class="box-body">
          <form role="form" name="frmNewUser" id="frmNewUser" method="POST" action="{{ route('cms.user-management.store') }}" autocomplete="false">
            @csrf
            <div class="row">          
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group @error('name') has-error @enderror">
                  ...
                  <input type="email" class="form-control" id="usrmail" name="usrmail" placeholder="Email" value="{{ old('usrmail') }}">
                  @error('usrmail')
                    <span class="help-block"><strong>{{ $message }}</strong></span>
                  @enderror
                </div>
            ...
            <div class="row">          
              <div class="col-md-6">
                <div class="form-group @error('usrname') has-error @enderror">
                  ...
                  <input type="text" class="form-control" id="usrname" name="usrname" placeholder="User name"  value="{{ old('usrname') }}">
                  @error('usrname')
                    <span class="help-block"><strong>{{ $message }}</strong></span>
                  @enderror
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group @error('usrname') has-error @enderror">
                  ...
                  <input type="text" class="form-control" id="usrpwd" name="usrpwd" placeholder="Password">
                  @error('usrpwd')
                    <span class="help-block"><strong>{{ $message }}</strong></span>
                  @enderror
                </div>
